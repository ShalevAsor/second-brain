...
// import { findFolderByPath } from "@/lib/folderHelpers"; // ✅ NEW
...
//       // ✅ FIXED: Use path-based matching for folders
...
//       // ✨ Format content with AI (if under length limit)
...
//       // ✅ FIXED: Only create folder if AI suggested NEW root-level folder
//       if (aiSuggestion?.folderPath && !folderId) {
//         // Check if path contains "/" (nested path)
//         if (aiSuggestion.folderPath.includes("/")) {
//           // This shouldn't happen with new prompt, but handle gracefully
//           console.warn(
...
//           }
//         } else {
//           // Simple root-level folder name (expected case)
//           const folderResult = await createFolderMutation.mutateAsync({
